...
public class PersonController {
   ...
   @Autowired
    ...
    public String handleRegisterForm(@ModelAttribute("person") Person person, BindingResult bindingResult) throws SQLException {
...
//        }
    ...
    public ModelAndView getUsersPage(){
        return new ModelAndView("patients","patients",personService.getAllPersons());
    }

    @RequestMapping(value="/updateperson", method= RequestMethod.POST)
    public String updateStatus(@RequestParam("name") String name, @RequestParam("id") int id){
        personService.updatePersonName(name+1, id);
